# Elite Skills + ATS Unified Project

A unified project combining the **Elite Skills** (Elite-skills) landing page with the **ATS Resume Checker** app. Visitors see the landing page; logged-in users are redirected to the ATS dashboard.

## Overview

- **Connected landing page to ATS** – Single app flow: guests see Elite Skills at `/`, logged-in users go to ATS dashboard at `/checker`
...
GEMINI_API_KEY=your_gemini_api_key   # For Elite Skills AI features
```
...
- **Unauthenticated**: Landing page (Elite Skills) at `/`
...
- **Landing page**: Elite Skills marketing content, AI simulation, strategy generator
...
- **AI**: Gemini (Elite Skills), PDF parsing (ATS)
